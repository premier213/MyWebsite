  ...
  <div className="sm:bg-white xl:items-center xl:justify-center xl:bg-gray-300 flex min-h-screen">
    <div className="rounded-4xl sm:flex-row xl:flex-row-reverse xl:w-75v xl:h-75v xl:bg-white flex flex-col">
      ...
      <div className=" 2xl:my-10h xl:my-10h xl:mx-20 h-60v sm:my-20h sm:w-70v sm:h-80v my-10h mx-12">
        ...
        <div className="2xl:ml-56 font-display 2xl:text-5xl xl:-mt-40 xl:ml-48 sm:text-4xl xl:text-4xl sm:flex sm:-mt-10h sm:ml-10v sm:justify-start mt-2 text-3xl text-center text-gray-700">
          {name}
        </div>
        <div className="xl:hidden 2xl:text-3xl xl:mt-4 xl:max-w-sm xl:text-2x sm:mt-5h sm:ml-10v sm:w-40v l sm:text-3xl sm:justify-start flex justify-center mt-2 text-xl text-gray-700">
          <button
            type="button"
        ...
        <div className="2xl:ml-56 2xl:mt-8 xl:mt-4 xl:ml-48 sm:max-w-sm sm:ml-10v sm:justify-start sm:mt-10h sm:text-xl sm:flex justify-center mt-4 text-base text-gray-800">
          {describe}
        </div>
        <div className="2xl:ml-56 2xl:mt-16 2xl:text-3xl xl:mt-4 xl:text-2xl xl:ml-48 sm:flex sm:justify-start sm:ml-10v sm:mt-10h font-display sm:text-3xl mt-2 text-xl text-center text-gray-700">
          {MySkill}
        </div>
        <div className="2xl:ml-56 xl:ml-48 w-70v sm:max-w-sm sm:ml-10v sm:flex-none sm:flex-wrap sm:flex-start mt-4 text-gray-800">
          <Swiper
            slidesPerView={2.4}
            autoplay={{ delay: 2000 }}
            loop="true"
